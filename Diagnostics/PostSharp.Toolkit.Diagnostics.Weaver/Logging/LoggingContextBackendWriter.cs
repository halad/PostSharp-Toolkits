...
{
    public sealed class LoggingContextBackendWriter : LoggingBackendWriter
    {
        public LoggingContextBackendWriter(LoggingContext loggingContext)
            : base(loggingContext)
        {
        }
        ...
        {
            if (LoggingContext.IsTraceEnabledMethod != null)
            {
                // todo implement IsXXXEnabled check
            }
